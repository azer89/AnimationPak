...
_dt = 0.2;   --- 0.05 for good result? (Do not set this higher than 0.1)
...
--- Force parameters
_k_connector           = 10;
_k_edge_start          = 1.0;   -- 5 edge force for filling elements
_k_edge_end            = 0.1;     --- 5 edge force for filling elements
